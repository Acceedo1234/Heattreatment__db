...
static uint8_t dest_ip[4] = {192,168,0,206};
static uint16_t dest_port =9009;
...
uint8_t unitId;
uint16_t temperatureHighTCP,temperatureLowTCP;
uint8_t durationHrS1,durationMinS1,durationHrS2,durationMinS2,statusTCP,skipIdTCP;
...
void receivehttpcheck(void)
{
	...
	if(filtereddata[0] == '$'){
	unitId = filtereddata[2]-48 +((filtereddata[1]-48)*10);
	temperatureHighTCP 	 =  filtereddata[18]-48 +((filtereddata[17]-48)*10)+((filtereddata[16]-48)*100)+((filtereddata[15]-48)*1000);
	temperatureLowTCP	 =  filtereddata[23]-48 +((filtereddata[22]-48)*10)+((filtereddata[21]-48)*100)+((filtereddata[20]-48)*1000);
	durationHrS1	=  filtereddata[26]-48 +((filtereddata[25]-48)*10);
	durationMinS1	=  filtereddata[28]-48 +((filtereddata[27]-48)*10);
	durationHrS2	=  filtereddata[31]-48 +((filtereddata[30]-48)*10);
	durationMinS2	=  filtereddata[33]-48 +((filtereddata[32]-48)*10);
	//No implementation
	statusTCP = filtereddata[42]-48 +((filtereddata[41]-48)*10);;
	skipIdTCP = filtereddata[45]-48 +((filtereddata[44]-48)*10);;
	}
}
